...
ENV VIRTUAL_ENV /opt/resale-prop-analysis-env
ENV PATH $VIRTUAL_ENV/bin:$PATH
RUN python -m venv $VIRTUAL_ENV

# Set the working directory.
WORKDIR /workspaces/resale-prop-analysis/
...
COPY --chown=user:user poetry.lock* pyproject.toml /workspaces/resale-prop-analysis/
...
COPY --chown=user:user .pre-commit-config.yaml /workspaces/resale-prop-analysis/
